...
public final class IIServer extends JPanel implements ActionListener
{
	static void createAndShowGUI(IIServer serverPanel, String title)
	{
	...
	public static void main(String[] args)
	{
		...
		final IIServer serverPanel = new IIServer();
		javax.swing.SwingUtilities.invokeLater(new Runnable()
		{
			...
			public void run()
			{
				createAndShowGUI(serverPanel, "II Game Server");
			}
		});
	}
	...
	public IIServer()
	{
		...
		startClockSpinner = new JSpinner(new SpinnerNumberModel(15,5,300,1));
		...
		scheduler = new Scheduler(matchesTabbedPane, schedulingPanel, leaderboardPanel, true);
