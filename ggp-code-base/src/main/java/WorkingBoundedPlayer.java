...
public class WorkingBoundedPlayer extends StateMachineGamer {
	@Override
	...
	final double MAX_LEVEL = 15; // TODO level
...
//			return MyHeuristics.nStepMobility(role, currState, 0, getStateMachine()); // TODO
